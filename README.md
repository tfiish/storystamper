...
5. Click Clear Video in the left panel, under Replace Video, to start over. The story text clears and your styling carries over to the next clip. It does not ask first—Command-Z puts the video and the text back, as it does for adding or removing a block, restyling one, and moving one.
